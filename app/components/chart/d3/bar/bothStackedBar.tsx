...
const BothStackedBarChart: React.FC = () => {
  useEffect(() => {
    d3.select("#both_stacked_bar").select("svg").remove();
    ...
    const color = d3
      .scaleOrdinal()
      .domain(typeKeys)
      .range(["rgba(109, 142, 189, 0.5)", "rgba(163, 106, 152, 0.5)"]);
  ...
  return <div id="both_stacked_bar" />;
};

export default BothStackedBarChart;
