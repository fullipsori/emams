        ...
        <React.Fragment>
            <Row className="m-page-title-box">
                <Col lg={3} className='d-sm-flex align-items-center'>
                        ...
                        <select className="form-select mb-0 ml-3" style={{width:"60%"}} aria-label="mlsn select ">
                ...
                <Col lg={3} className='d-sm-flex align-items-center'>
                        ...
                        <select className="form-select mb-0 ml-3" style={{width:"60%"}} aria-label="queue select ">
                ...
                <Col lg={4} className='ml-auto d-sm-flex align-items-center'>
...
export default MonitorHeader;
            ...
            //             <div className="ml-auto d-sm-flex align-items-center">
            //                 <div className="flex-shrink-0 avatar-xs ml-3">
            //                     <span className="avatar-title bg-light p-1 rounded-circle">
            //                         <img src={btc} className="img-fluid" alt="" />
            //                     </span>
            ...
            //         </div>
            //     </Col>
                {/* <Col xs={6} className="col-lg-auto page-title-right d-sm-flex justify-content-end">
                </Col> */}
